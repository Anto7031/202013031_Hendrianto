...
//        System.exit(0);
    ...
    private void masukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_masukActionPerformed
        ...
        {
            //splashscreen ss=new splashscreen();//Membuat Instant dari kelas Beranda
            //ss.main(dataku);//Menyimpan data dari array dataku ke method main pada kelas beranda
            //ss.setVisible(true);//Menampilkan kelas beranda
            this.dispose();//Menutup kelas Login
            a();
        }   
        else {
         int dialogButton = JOptionPane.showConfirmDialog (null, "Sandi atau Passsword Yang anda Masukkan Salah?","PERINGATAN",JOptionPane.YES_OPTION,JOptionPane.WARNING_MESSAGE);
